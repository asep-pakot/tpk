	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="text" name="nama_bumil" value="<?=$data_row['nama_bumil'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Nama Bumil -->
			<!-- input text | No Wa -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<select name="renc_hamil" class="form-control" style="max-width:400px;" required>
						<option value="<?=$data_row['renc_hamil'];?>" style="display:none;"><?=$data_row['renc_hamil'];?></option><option value="3">3</option>
					</select>
				</div>
			</div>
			<!--/ input select ENUM | Renc Hamil -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="text" name="usia_kand" value="<?=$data_row['usia_kand'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Usia Kand -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<select name="renc_lahir" class="form-control" style="max-width:400px;" required>
						<option value="<?=$data_row['renc_lahir'];?>" style="display:none;"><?=$data_row['renc_lahir'];?></option><option value="3">3</option>
					</select>
				</div>
			</div>
			<!--/ input select ENUM | Renc Lahir -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="number" name="materi" value="<?=$data_row['materi'];?>" class="form-control" required />
				</div>
			</div>
			<!--/ input number | Materi -->
