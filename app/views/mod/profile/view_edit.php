			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group mg-b-25">
						...
						<input type="text" name="about" class="form-control" value="<?=trim(set_value('about')) != "" ? trim(set_value('about')) : $this->data['user_about'];?>" />
					</div>
					<!--/ About -->
					<!-- Address -->
					<div class="form-group mg-b-25">
						<label><?=lang_line('_address');?></label>
						<input type="text" name="address" class="form-control" value="<?=trim(set_value('address')) != "" ? trim(set_value('address')) : $this->data['user_address'];?>" />
