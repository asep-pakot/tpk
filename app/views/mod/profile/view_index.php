...
<div class="page-inner">
	...
	<div class="card mg-b-30">
		...
		<div class="col-md-6">
			...
			<div class="row mb-2">
				<div class="col-md-2 col-sm-3 tx-gray-700 tx-semiboldX"><?=lang_line('_prov');?> :</div>
				<div class="col-sm-9"><?=$this->data['provinsi']; ?></div>
			</div>
			<div class="row mb-2">
				<div class="col-md-2 col-sm-3 tx-gray-700 tx-semiboldX"><?=lang_line('_kab');?> :</div>
				<div class="col-sm-9"><?=$this->data['kabupaten']; ?></div>
			</div>			
			<div class="row mb-2">
				<div class="col-md-2 col-sm-3 tx-gray-700 tx-semiboldX"><?=lang_line('_kec');?> :</div>
				<div class="col-sm-9"><?=$this->data['kecamatan']; ?></div>
			</div>						
			<div class="row mb-2">
				<div class="col-md-2 col-sm-3 tx-gray-700 tx-semiboldX"><?=lang_line('_desa');?> :</div>
				<div class="col-sm-9"><?=$this->data['desa']; ?></div>
			</div>									
			<div class="row mb-2">
				<div class="col-md-2 col-sm-3 tx-gray-700 tx-semiboldX"><?=lang_line('_rw');?> :</div>
				<div class="col-sm-9"><?=$this->data['rw']; ?></div>
			</div>
			<div class="row mb-2">
				<div class="col-md-2 col-sm-3 tx-gray-700 tx-semiboldX"><?=lang_line('_rt');?> :</div>
				<div class="col-sm-9"><?=$this->data['rt']; ?></div>
			</div>									
		</div>    
	</div>
</div>
