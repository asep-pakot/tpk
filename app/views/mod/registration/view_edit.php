			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<textarea name="about" class="form-control" rows="2"><?=$res_user['about'];?></textarea>
					</div>
				</div>
				<!--/ About -->
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="address" class="form-control" value="<?=$res_user['address'];?>" />
					</div>
				</div>
				<!--/ Address -->
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?=lang_line('_prov');?></label>
						<!---input type="text" name="provinsi" class="form-control" value="<?=$res_user['provinsi'];?>" /--->
						<select name="provinsi" value="<?=$res_user['provinsi'];?>" class="select2 form-control" data-placeholder="- <?=lang_line('_prov');?> -">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?=lang_line('_kab');?></label>
						<!---input type="text" name="kabupaten" class="form-control" value="<?=$res_user['kabupaten'];?>" /--->
						<select name="provinsi" value="<?=$res_user['kabupaten'];?>" class="select2 form-control" data-placeholder="- <?=lang_line('_kab');?> -">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?=lang_line('_kec');?></label>
						<!---input type="text" name="kecamatan" class="form-control" value="<?=$res_user['kecamatan'];?>" /--->
						<select name="provinsi" value="<?=$res_user['kecamatan'];?>" class="select2 form-control" data-placeholder="- <?=lang_line('_kec');?> -">
						    <option value="">- <?=lang_line('_kec');?> -</option>
						    <option value="Lembang">Lembang</option>
						    <option value="Lembang">Parongpong</option>
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?=lang_line('_desa');?></label>
						<input type="text" name="desa" class="form-control" value="<?=$res_user['desa'];?>" />
					</div>
				</div>
				<!--/ Desa -->	
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?=lang_line('_rw');?></label>
						<input type="text" name="rw" class="form-control" value="<?=$res_user['rw'];?>" />
					</div>
				</div>
				<!--/ Rw -->	
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?=lang_line('_rt');?></label>
						<input type="text" name="rt" class="form-control" value="<?=$res_user['rt'];?>" />
					</div>
				</div>
				<!--/ Rt -->	
