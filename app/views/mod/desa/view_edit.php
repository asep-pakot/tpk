...
<div class="page-inner">
			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item">Desa</a>
						<a href="#" class="breadcrumb-item">Edit Data</a>
					</div>
					<h4 class="pd-0 mg-0 tx-20">Desa</h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<!--/ input text | Desa -->
			<!-- input text | Kode Desa -->
			<div class="form-group row">
				<label class="col-form-label col-md-2">Kode Desa</label>
				<div class="col-md-10">
					<input type="text" name="kode_desa" value="<?=$data_row['kode_desa'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Kode Desa -->
			<!-- textarea | Ket -->
			<div class="form-group row">
				...
				<div class="col-md-10">
					<textarea name="ket" class="form-control"><?=$data_row['ket'];?></textarea>
				</div>
			</div>
			<!--/ textarea | Ket -->
			</div> <!-- card-body -->
