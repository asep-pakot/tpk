	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input type="text" name="nama_catin" value="<?=$data_row['nama_catin'];?>" class="form-control" />
				</div>
			</div>
			<!--/ input text | Nama Catin -->
			<!-- input text | No Wa -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<div class="input-group" style="max-width:250px;">
						<input id="date-picker" type="text" name="tgl_akad" value="<?=$data_row['tgl_akad'];?>" class="form-control" placeholder="yyyy-mm-dd" required/>
						<div class="input-group-append">
							<span class="input-group-text"><i class="fa fa-calendar"></i></span>
						</div>
					</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<select name="dok_na" class="form-control" style="max-width:400px;" required>
						<option value="<?=$data_row['dok_na'];?>" style="display:none;"><?=$data_row['dok_na'];?></option><option value="2">2</option>
					</select>
				</div>
			</div>
			<!--/ input select ENUM | Dok Na -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<select name="ttd" class="form-control" style="max-width:400px;" required>
						<option value="<?=$data_row['ttd'];?>" style="display:none;"><?=$data_row['ttd'];?></option><option value="2">2</option>
					</select>
				</div>
			</div>
			<!--/ input select ENUM | Ttd -->
			...
			<div class="form-group row">
				...
				<div class="col-md-10">
					<select name="elsimil" class="form-control" style="max-width:400px;" required>
						<option value="<?=$data_row['elsimil'];?>" style="display:none;"><?=$data_row['elsimil'];?></option><option value="2">2</option>
					</select>
				</div>
			</div>
			<!--/ input select ENUM | Elsimil -->
