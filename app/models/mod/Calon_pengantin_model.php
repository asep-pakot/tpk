...
class Calon_pengantin_model extends CI_Model {

	public $vars;
	private $_table = 't_catin';
	private $_column_order = array(null, 'id', 'nama_kk', 'nama_catin', 'elsimil', 'materi', 'id');
	private $_column_search = array('id', 'nama_kk', 'nama_catin', 'elsimil', 'materi', 'id');
