...
class Rukun_warga_model extends CI_Model {

	public $vars;
	private $_table = 't_rw';
	private $_column_order = array(null, 'id', 'kecamatan', 'desa', 'erw', 'id');
	private $_column_search = array('id', 'kecamatan', 'desa', 'erw', 'id');
