...
class Remaja_model extends CI_Model {
	...
	public $vars;
	private $_table = 't_remaja';
	private $_column_order = array(null, 'id', 'nama_kk', 'nama_remaja', 'gender', 'materi', 'id');
	private $_column_search = array('id', 'nama_kk', 'nama_remaja', 'gender', 'materi', 'id');
