...
class Hamil_model extends CI_Model {
	...
	public $vars;
	private $_table = 't_hamil';
	private $_column_order = array(null, 'id', 'nama_kk', 'nama_bumil', 'renc_lahir', 'id');
	private $_column_search = array('id', 'nama_kk', 'nama_bumil', 'renc_lahir', 'id');
